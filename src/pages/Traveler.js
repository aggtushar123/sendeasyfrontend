...
const Traveler = () => {
  return (
    <div className="flex gap-5 justify-between items-start px-7 pt-7 pb-12 mt-16 w-full bg-gray-100 max-w-[1239px] rounded-[38px] max-md:flex-wrap max-md:px-5 max-md:mt-10 max-md:max-w-full">
      <img
        loading="lazy"
        srcSet="..."
        className="shrink-0 self-stretch my-auto max-w-full aspect-[0.76] w-[111px]"
      />
      <div className="flex flex-col max-md:max-w-full">
        <div className="flex gap-5 justify-between px-px leading-[158.5%] text-slate-900 max-md:flex-wrap">
          ...
          <img
            ...
            className="my-auto border-2 border-sky-200 border-solid aspect-[25] stroke-[2px] stroke-sky-200 w-[276px]"
          />
        ...
        <div className="flex gap-5 mt-16 w-full max-md:flex-wrap max-md:mt-10 max-md:max-w-full">
          ...
          <div className="flex flex-auto gap-5 justify-between pr-3.5 leading-[158.5%] text-slate-900 max-md:flex-wrap max-md:max-w-full">
