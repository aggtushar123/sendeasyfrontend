  ...
  return (
    <div className="flex gap-5 justify-between pt-5 ml-5 mr-5 max-md:flex-wrap max-md:max-w-full">
      ...
      <div className="flex gap-5 justify-between items-center my-auto text-slate-900 max-md:flex-wrap">
        ...
        <Link className="self-stretch my-auto" to="/about">About Us</Link>
        <Link className="flex-auto self-stretch my-auto" to="/contact">Contact Us</Link>
        <Link className="flex flex-col flex-1 justify-center self-stretch text-center text-white whitespace-nowrap" to="/login">
          <div className="justify-center px-14 py-3 bg-sky-400 rounded-[31px] max-md:px-5">
          Login
          </div>
        </Link>
        <Link className="flex flex-col flex-1 justify-center self-stretch font-semibold text-sky-400 whitespace-nowrap" to="/signup">
