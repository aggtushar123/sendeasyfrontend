...
import { deleteAllNotification, getAllNotifications} from "../../features/auth/authSlice";
const Notifications = () => {
      ...
      <div className="flex max-md:flex-col max-md:gap-0">
        ...
        <div className="flex flex-col  w-[86%] max-md:ml-0 max-md:w-full">
          <div className="flex flex-col items-center py-12 pr-20 pl-8 bg-neutral-100 max-w-[978px] rounded-[39px] max-md:px-5">
            ...
            {notification?.map((notificationMessage) => (
            <div className="flex gap-5 py-3 pr-9 pl-3.5 mt-6 max-w-full bg-white shadow-2xl rounded-[64.093px] w-[808px] max-md:flex-wrap max-md:pr-5">
