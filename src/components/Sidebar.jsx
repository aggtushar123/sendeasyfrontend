    ...
    <>
      ...
      <div className='flex flex-col grow  text-base text-sky-400  mt-5 max-md:mt-10'>
        <div className='flex flex-col self-stretch py-9 -ml-px w-[185px] h-[765px] bg-gray-100 grow-0 rounded-[39px]'>
          <img
            loading='lazy'
            srcSet='https://images.unsplash.com/photo-1534528741775-53994a69daeb?q=80&w=2864&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'
